 ...
 */
export function getLightConfig(time: TimeOfDay): maplibregl.LightSpecification {
  return {
    anchor: 'map',
 ...
 */
export function getSkyConfig(time: TimeOfDay): maplibregl.SkySpecification {
  return {
 ...
 */
export function getFeatureColors(time: TimeOfDay) {
  return {
    // Runway colors
 ...
 */
export const TAXIWAY_LIGHT_COLORS = {
