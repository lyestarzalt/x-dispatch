 ...
 */
const SIGN_STYLES: Record<number, SignStyle> = {
  [SignSize.SMALL]: {
    fontSize: 10,
    minZoom: 17,
    textColor: '#FFFFFF',
 ...
 */
function parseSignTextLegacy(rawText: string): { text: string; isYellow: boolean } {
...
function getSignStyle(signSize: number): SignStyle {
...
function getSignMinZoom(signSize: number): number {
