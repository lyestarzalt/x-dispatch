...
export const selectSelectedICAO = (state: AppState) => state.selectedICAO;
export const selectSelectedAirport = (state: AppState) => state.selectedAirportData;
export const selectShowSidebar = (state: AppState) => state.showSidebar;
export const selectShowSettings = (state: AppState) => state.showSettings;
export const selectShowLaunchPanel = (state: AppState) => state.showLaunchDialog;
export const selectProcedure = (state: AppState) => state.selectedProcedure;
export const selectStartPosition = (state: AppState) => state.startPosition;
