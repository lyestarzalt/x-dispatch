...
// Selectors
export const selectLayerVisibility = (state: MapState) => state.layerVisibility;
export const selectNavVisibility = (state: MapState) => state.navVisibility;
export const selectIsNightMode = (state: MapState) => state.isNightMode;
export const selectDebugEnabled = (state: MapState) => state.debugEnabled;
export const selectVatsimEnabled = (state: MapState) => state.vatsimEnabled;
