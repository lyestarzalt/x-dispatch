/* eslint-disable react-hooks/set-state-in-effect -- PDF modal open/close lifecycle */
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogPortal>
        ...
        >
          <DialogTitle className="sr-only">{t('vac.modalTitle', { icao: chartIcao })}</DialogTitle>
