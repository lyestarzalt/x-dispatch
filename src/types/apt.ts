/**
 * Airport Types - apt.dat parsing types
 * All types related to X-Plane airport data format
 */
import type { Coordinates, LonLatPath, LonLatPolygon } from './geo';

// ============================================================================
// Row Codes - apt.dat line type identifiers
// ============================================================================
