...
// TODO: Weather Presets
// - Move WEATHER_PRESETS to a separate file (e.g., weatherPresets.ts)
// - Real Weather uses var_deft_change_enum=7 in Freeflight.prf (no command-line flag available)
// - All presets need full _wxr_def template, only changing specific weather parameters
// - var_deft_change_enum values: 0=static, 3=variable, 7=real weather (METAR)
