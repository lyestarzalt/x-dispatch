...
import { Airspace, AirwaySegment, Navaid, NavaidType, Waypoint } from '../navParser/types';
...
export class XPlaneDataManager {
  ...
  /**
   * Get airport procedures (CIFP)
   */
  getAirportProcedures(icao: string): AirportProcedures | null {
  ...
  getStatus(): DataLoadStatus {
    ...
    const airportCount = countResult.length;
