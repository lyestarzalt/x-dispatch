 ...
 */
import { LineLightingType, LinearFeature } from '@/lib/aptParser/types';
 ...
 */
export const LIGHT_CONFIGS: Record<LineLightingType, LightingConfig> = {
...
export function lightsToGeoJSON(lights: AirportLight[]): GeoJSON.FeatureCollection {
  return {
...
export function buildLightColorExpression(): maplibregl.ExpressionSpecification {
  return ['get', 'colorHex'] as maplibregl.ExpressionSpecification;
}

export function buildLightRadiusExpression(): maplibregl.ExpressionSpecification {
  return [
    'interpolate',
    ['linear'],
    ['zoom'],
...
export function buildGlowRadiusExpression(): maplibregl.ExpressionSpecification {
  return [
    'interpolate',
    ['linear'],
    ['zoom'],
