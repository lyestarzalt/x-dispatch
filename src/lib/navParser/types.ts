...
export interface NavaidGeoJSON extends GeoJSON.FeatureCollection {
...
export interface WaypointGeoJSON extends GeoJSON.FeatureCollection {
  features: GeoJSON.Feature<
    GeoJSON.Point,
    {
      id: string;
...
export interface AirspaceGeoJSON extends GeoJSON.FeatureCollection {
  features: GeoJSON.Feature<
    GeoJSON.Polygon,
    {
      class: string;
