 ...
 */
export function groupByAirway(segments: AirwaySegment[]): Map<string, AirwaySegment[]> {
 ...
 */
export function getHighAirways(segments: AirwaySegment[]): AirwaySegment[] {
 ...
 */
export function getLowAirways(segments: AirwaySegment[]): AirwaySegment[] {
  return segments.filter((s) => !s.isHigh);
}
 ...
 */
export function findAirwaysByFix(segments: AirwaySegment[], fixId: string): AirwaySegment[] {
