 ...
 */
function filterNavaidsByType(navaids: Navaid[], types: NavaidType[]): Navaid[] {
 ...
 */
function getVORs(navaids: Navaid[]): Navaid[] {
 ...
 * Get NDBs
 */
function getNDBs(navaids: Navaid[]): Navaid[] {
 ...
 */
function getDMEs(navaids: Navaid[]): Navaid[] {
 ...
 * Get ILS/Localizers
 */
function getILS(navaids: Navaid[]): Navaid[] {
 ...
 * Get Glideslopes
 */
function getGlideslopes(navaids: Navaid[]): Navaid[] {
 ...
 */
function getMarkers(navaids: Navaid[]): Navaid[] {
 ...
 */
function getFPAPs(navaids: Navaid[]): Navaid[] {
 ...
 */
function getGLS(navaids: Navaid[]): Navaid[] {
 ...
 */
function getLTPFTP(navaids: Navaid[]): Navaid[] {
 ...
 */
function getILSComponents(navaids: Navaid[], airport: string, runway?: string): Navaid[] {
 ...
 */
function getApproachAids(navaids: Navaid[], airport: string, runway?: string): Navaid[] {
  return navaids.filter((n) => {
