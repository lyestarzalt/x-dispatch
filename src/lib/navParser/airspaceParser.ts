 ...
 */
export function filterAirspacesByClass(airspaces: Airspace[], classes: string[]): Airspace[] {
 ...
 */
export function getControlledAirspaces(airspaces: Airspace[]): Airspace[] {
 ...
 */
export function getRestrictedAirspaces(airspaces: Airspace[]): Airspace[] {
